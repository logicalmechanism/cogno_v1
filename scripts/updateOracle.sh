...
tag_utxo=$(${cli} transaction txid --tx-file tmp/oracle-tx.signed)
...
FEE=$(${cli} transaction build \
    ...
    --tx-out-inline-datum-file data/datum/oracle_datum.json \
