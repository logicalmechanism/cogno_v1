...
rank_utxo=$(${cli} transaction txid --tx-file tmp/rank-tx.signed)
...
FEE=$(${cli} transaction build \
    ...
    --spending-reference-tx-in-redeemer-file data/redeemer/dislike_redeemer.json \
    --tx-out="${sc_address_out}" \
    --tx-out-inline-datum-file data/datum/rank_datum.json \
